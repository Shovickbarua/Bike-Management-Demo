...
<div class="row">
			<div class="col-lg-12">
				<div class="card">
                <form id="myForm" method="GET" id="myForm" action="{{route('in_reports')}}" >
                    @csrf
                    <div class="form-row mt-2 ml-2">
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <a href="{{route('in_report')}}" class="btn btn-success btn-md mr-2">Report</a>               
                        </div>
                    </div>
                </form>
            ...
            <table id="" class="table table-bordered table-striped">
                ...
                <th>Amount</th>
                          ...
                          <tr>
                            ...
                            <th >
                                <div class="col-md-6"><span class="pl-5 "><strong>{{$in}}</strong></span></div>
                            </th>
                          </tr>
						</table>
					</div>
