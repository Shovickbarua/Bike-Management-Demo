	...
	<div class="wrapper">
		...
		<table class="border container1">
			...
			<tr>
				...
				<td align="center" class="border">{{$expense->ex_name}}</td>
				<td align="center" class="border">{{$expense->dob}}</td>
				<td align="center" class="border">{{$expense->amount}}</td>
			</tr>
			@endforeach
			<tr>
				<th colspan="3" class="border">Total Amount</th>
				<td align="center" class="border">{{$ex}}</td>
			</tr>
		</table>
	</div>
