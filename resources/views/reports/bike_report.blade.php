	...
	<div class="wrapper">
		...
		<table class="border container1">
			...
			<tr>
				...
				<td align="center" class="border">{{$bike->brand}}</td>
				<td align="center" class="border">{{$bike->bike_name}}</td>
				<td align="center" class="border wd">{{$bike->bsquantity}}</td>
				<td align="center" class="border">{{$bike->dob}}</td>
				<td align="center" class="border">{{$bike->profit}}</td>
			</tr>
			@endforeach
			<tr>
				<th colspan="5" class="border">Total Profit</th>
